...
<body>
    ...
    <nav class="navbar fixed-top">
        ...
        <div class="right">
            <a class="navbar-back" href="../php/main.php">BACK</a>
        </div>
    </nav>

    <div class="container-fluid">
        <!-- <div class="footer">
            <img src="/images/subject_footer.svg" alt="">
        </div> -->
        ...
        <a href="../Filipino Page/result_filipino.php">
          <div class="column hvr-grow" style="width: 308px">
            ...
            <br>
              ...
              <p class="card-text">
                Welcome to Filipino this is the new <br> beginning of another chapter
                where <br> Filipino will be your friend. It aims to <br> provide young
                children's curiosity to <br> be answered by Filipino and discover <br>
        ...
        <a href="../Math Page/php/result_math.php">
          <div class="column hvr-grow" style="width: 308px">
            ...
            <br>
              ...
              <p class="card-text">
              Welcome to Math this is the new <br> beginning of another chapter
                where <br> Math will be your friend. It aims to <br> provide young
                children's curiosity to <br> be answered by Math and discover <br>
                more, evidently this website will help <br> young minds to expand
                their cognition<br>to different forms.
                </p>
            </div>
